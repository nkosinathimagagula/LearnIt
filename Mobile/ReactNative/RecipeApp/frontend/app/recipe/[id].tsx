...
const RecipeDetailScreen = () => {
    ...
    const [recipe, setRecipe] = useState<TransformedMealType>();
    ...
    const checkIfRecipeIsSaved = async () => {
        try {
            ...
            const isRecipeSaved = favourites.some((item: any) => item.recipeId === parseInt(id))
    ...
    const handleToggleSave = async () => {
        ...
        try {
            if (isSaved) {
                const response = await fetch(`${API_URL}/favourites/${userId}/${id}`, { method: "DELETE" })
        ...
        >
            ...
            >
                ...
                <View style={recipeDetailStyles.floatingButtons}>
                    ...
                    <TouchableOpacity
                        // TODO
                        style={[recipeDetailStyles.floatingButton, { backgroundColor: isSaving ? '' : COLORS.primary }]}
                ...
                <View style={recipeDetailStyles.contentSection}>
                            ...
                            <View style={recipeDetailStyles.sectionContainer}>
                                ...
                                <View style={recipeDetailStyles.videoCard}>
                                    <WebView
                                        ...
                                        source={{ uri: getYoutubeEmbedUrl(recipe.video) }}
                    ...
                    <TouchableOpacity
                        ...
                        disabled={isSaving}
                    >
                        <LinearGradient style={recipeDetailStyles.buttonGradient} colors={[COLORS.primary, COLORS.primary + "CC"]}>
